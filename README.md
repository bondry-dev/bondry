...
The workspace contains the protocol-neutral dispatch core with JSON Schema 2020-12 input validation, client authentication lifecycle, exact authorization grants, runtime-neutral outbound transport contracts, a shared local HTTP runtime, generic REST and MCP adapters, fixed verified webhook ingress, an optional encrypted SQLCipher reference store, generic credential-storage contracts, a secure Unix private-file provider, versioned composition ABIs, an Apple Keychain provider, modular native Swift products, and an Apple Shortcuts adapter built with App Intents.

See [Architecture](docs/architecture.md), [Authentication](docs/authentication.md), [Authorization](docs/authorization.md), [Outbound transport](docs/transport.md), [Webhook egress](docs/egress-webhook.md), [Webhook ingress](docs/webhook-ingress.md), [Local HTTP](docs/http.md), [Implementation limits](docs/implementation-limits.md), [REST](docs/rest.md), [MCP](docs/mcp.md), [Apple server controls](docs/apple-server.md), [Apple Shortcuts](docs/apple-shortcuts.md), [Apple distribution](docs/apple-distribution.md), [Releasing](docs/releasing.md), [Storage](docs/storage.md), [C ABI](docs/c-abi.md), [Apple Keychain](docs/apple-keychain.md), [Threat model](docs/threat-model.md), [Repository safety](docs/repository-safety.md), [Phase 0 performance baseline](docs/performance/phase-0/README.md), [Phase 2 egress artifact measurements](docs/performance/egress-phase-2.md), and [Phase 6 release profile](docs/performance/phase-6/README.md) for the current design constraints.
