...
See [Architecture](docs/architecture.md), [Authentication](docs/authentication.md), [Authorization](docs/authorization.md), [Local HTTP](docs/http.md), [REST](docs/rest.md), [MCP](docs/mcp.md), [Apple server controls](docs/apple-server.md), [Apple Shortcuts](docs/apple-shortcuts.md), [Storage](docs/storage.md), [C ABI](docs/c-abi.md), [Apple Keychain](docs/apple-keychain.md), [Threat model](docs/threat-model.md), and [Repository safety](docs/repository-safety.md) for the current design constraints.
